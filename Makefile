...
dockerfile: clean
	docker build -t quay.io/ant31/pyjsonnet:v$(VERSION) .

dockerfile-canary: clean
	docker build -t quay.io/ant31/pyjsonnet:canary .
	docker push quay.io/ant31/pyjsonnet

dockerfile-push: dockerfile
	docker push quay.io/ant31/pyjsonnet:v$(VERSION)
